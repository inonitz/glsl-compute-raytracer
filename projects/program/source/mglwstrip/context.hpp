...
*/
using Material = util::math::vec4f;
...
{
	util::math::vec3f position;
	util::math::vec2f viewport;
	f32         focal_length;
	u32         reserved;
};
...
{
	util::math::mat4f invView;
	util::math::mat4f invPerspective;
	util::math::vec3f position;
};
...
typedef struct __CameraAndPerspectiveStruct
{
	...
	void create(
    	...
    	util::math::vec3f const& initialPosition  = { 0.0f, 0.0f,  6.0f },
    	util::math::vec3f const& initialDirection = { 0.0f, 0.0f, -1.0f }
	);
